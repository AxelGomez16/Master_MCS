...
from map_world_weekly_cases import *
...
navbar = dbc.NavbarSimple(
  children=[
    # dbc.NavItem(dbc.NavLink("Weekly cases - Map world", href="/bar-charts")), # TODO: Change url
    dbc.NavItem(dbc.NavLink("Weekly cases - Map world", href="/map-world-weekly-cases")),
...
home_layout = html.Div([
  ...
  html.Div([
    dbc.Card(
      dbc.CardBody([
        html.H3("📊 Weekly cases - Map world", className="card-title"),
        html.P("Interactive map showing weekly cases by country"),
        dbc.Button("Go to Map world", href="/map-world-weekly-cases", color="primary"), # TODO: Change url
      ]),
      className="m-3"
    ),
    dbc.Card(
...
# Map Page
# -------------------------------
choropleth_layout = create_choropleth_component()
...
def display_page(pathname):
  if pathname == '/map-world-weekly-cases':
